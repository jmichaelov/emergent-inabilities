...
TASK_REGISTRY = {
    ...
    **mgsm.construct_tasks(),
    "isp_sig_figs": isp_tasks.ISPSigFigs,
    "isp_resisting_correction": isp_tasks.ISPResistingCorrection,
    "isp_repetitive_algebra": isp_tasks.ISPRepetitiveAlgebra,
    "isp_pattern_matching_suppression": isp_tasks.ISPPatternMatchingSuppression,
    "isp_modus_tollens": isp_tasks.ISPModusTollens,
    "isp_into_the_unknown": isp_tasks.ISPIntoTheUnknown,
    "isp_redefine": isp_tasks.ISPRedefine,
    "isp_neqa": isp_tasks.ISPNeQA,
    "isp_memo_trap": isp_tasks.ISPMemoTrap,
    "isp_hindsight_neglect": isp_tasks.ISPHindsightNeglect
